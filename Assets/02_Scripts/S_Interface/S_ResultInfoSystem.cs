...
public class S_ResultInfoSystem : MonoBehaviour
{
    ...
    public async Task CalcResultGoldAsync(int health, int determination, int omen, int robbery, int greed)
    {
        ...
        go1.GetComponent<S_ResultBase>().SetResultBase("피조물 처치 골드", "5");
        ...
        if (S_GameFlowManager.Instance.CurrentTrial % 3 == 0)
        {
            ...
            go2.GetComponent<S_ResultBase>().SetResultBase("강력한 피조물 처치 추가 골드", "5");
        ...
        if (omen > 0)
        {
            ...
            go5.GetComponent<S_ResultBase>().SetResultBase("흉조 카드에 의한 골드", determination.ToString());
        ...
        if (robbery > 0)
        {
            ...
            go6.GetComponent<S_ResultBase>().SetResultBase("강도 카드에 의한 골드", determination.ToString());
        ...
        if (greed > 0)
        {
            ...
            go7.GetComponent<S_ResultBase>().SetResultBase("탐욕 카드에 의한 골드", determination.ToString());
